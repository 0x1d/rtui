...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jquery2.default)(function () {
	  var c = new _Component2.default('.foo', '{{up_rate}}', '/rtorrent/api');
	  c.render();
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Component = function () {
	  function Component(selector, template, api) {
	  ...
	  (0, _createClass3.default)(Component, [{
	    key: 'loadData',
	    value: function loadData(done) {
	      fetch(this.api).then(this.toJsonResponse).then(done);
	    }
	  }, {
	    key: 'toJsonResponse',
	    ...
	    value: function render() {
	      ...
	      this.loadData(function (data) {
	        (0, _jquery2.default)(_this.selector).html(_mustache2.default.render(_this.template, data));
	      });
	    }
	  }]);
	  return Component;
