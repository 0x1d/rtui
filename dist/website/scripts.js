...
var _mustache = __webpack_require__(60);
...
var _DataField = __webpack_require__(73);
...
var _Mediator = __webpack_require__(71);

var _Mediator2 = _interopRequireDefault(_Mediator);

var _DataStore2 = __webpack_require__(74);

var _DataStore3 = _interopRequireDefault(_DataStore2);

var _StoreAction = __webpack_require__(27);
...
var _exports = __webpack_require__(70);
...
var _RestStore2 = __webpack_require__(41);
...
var RTorrentApi = function (_RestStore) {
  ...
  (0, _createClass3.default)(RTorrentApi, [{
    key: 'delete',
    value: function _delete(hash) {
      (0, _get3.default)(RTorrentApi.prototype.__proto__ || (0, _getPrototypeOf2.default)(RTorrentApi.prototype), 'delete', this).call(this, {
        action: 'multicall',
        call: 'd.erase',
        hash: hash
      });
    ...
    value: function loadAll() {
      (0, _get3.default)(RTorrentApi.prototype.__proto__ || (0, _getPrototypeOf2.default)(RTorrentApi.prototype), 'load', this).call(this, {
        action: 'getAll'
      });
    }
  }]);
...
var AddTorrent = function (_Component) {
    (0, _inherits3.default)(AddTorrent, _Component);

    function AddTorrent(ctx, node) {
...
var _FeedsApi = __webpack_require__(75);

var _FeedsApi2 = _interopRequireDefault(_FeedsApi);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var Feeds = function (_Component) {
    (0, _inherits3.default)(Feeds, _Component);

    function Feeds(ctx, node) {
        (0, _classCallCheck3.default)(this, Feeds);

        var _this = (0, _possibleConstructorReturn3.default)(this, (Feeds.__proto__ || (0, _getPrototypeOf2.default)(Feeds)).call(this, ctx, node));

        _this.feedsApi = new _FeedsApi2.default();
        return _this;
    }

    (0, _createClass3.default)(Feeds, [{
        key: 'init',
        value: function init() {
            var _this2 = this;

            _jquery2.default.when(_jquery2.default.get('/feeds/api/downloaded'), _jquery2.default.get('/feeds/api/feeds')).done(function (downloaded, feeds) {
                _this2.toDownloadedList(JSON.parse(downloaded[0]));
                _this2.toFeedsList(JSON.parse(feeds[0]));
                _this2.render(_this2.data);
            });
            this.node.delegate('.addFeed', 'click', this.addFeed.bind(this));
        }
    }, {
        key: 'toViewData',
        value: function toViewData(attribute, list) {
            var outList = [];
        ...
        key: 'toDownloadedList',
        value: function toDownloadedList(list) {
            return this.toViewData('downloaded', list);
        }
    }, {
        key: 'toFeedsList',
        value: function toFeedsList(list) {
...
var Modal = function (_Component) {
    ...
    function Modal(ctx, node) {
        (0, _classCallCheck3.default)(this, Modal);

        var _this = (0, _possibleConstructorReturn3.default)(this, (Modal.__proto__ || (0, _getPrototypeOf2.default)(Modal)).call(this, ctx, node));

        console.log('init');
        var fragmentId = _this.node.attr('href');
    ...
    (0, _createClass3.default)(Modal, [{
        ...
        value: function render(data) {
            return this.template.then(function (template) {
                return new _promise2.default(function (fulfill, reject) {
                    (0, _jquery2.default)('body').append(_mustache2.default.render(template, data));
                    fulfill();
                });
            });
        }
...
var _AddTorrent = __webpack_require__(63);

Object.defineProperty(exports, 'AddTorrent', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_AddTorrent).default;
  }
});

var _TorrentList = __webpack_require__(69);

Object.defineProperty(exports, 'TorrentList', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_TorrentList).default;
  }
});

var _Reload = __webpack_require__(67);
...
var _Feeds = __webpack_require__(64);

Object.defineProperty(exports, 'Feeds', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_Feeds).default;
  }
});
...
var _DataBinding = __webpack_require__(72);
...
var RTorrentApi = function (_RestStore) {
    ...
    function RTorrentApi() {
        (0, _classCallCheck3.default)(this, RTorrentApi);
        return (0, _possibleConstructorReturn3.default)(this, (RTorrentApi.__proto__ || (0, _getPrototypeOf2.default)(RTorrentApi)).call(this, '/feeds/api'));
    }
...
var _RTorrentApi = __webpack_require__(62);
...
(0, _jquery2.default)(function () {
    new _App2.default().withDataStore(new _RTorrentApi2.default()).run((0, _jquery2.default)('body'));
});
